                    ...
                    <Col lg='3'>
                        ...
                        <ListGroup className="footer__quick-links">
                                    <ListGroupItem className="ps-0 border-0 d-flex align-items-center gap-3">
                                        ...
                                        <p className="mb-0">Asansol, Kolkata WB</p>
                                    </ListGroupItem>
                                    ...
                                    <ListGroupItem className="ps-0 border-0 d-flex align-items-center gap-3">
                                        ...
                                        <p className="mb-0">singh03.avishek@gmail.com</p>
                                    </ListGroupItem>
                                    ...
                                    <ListGroupItem className="ps-0 border-0 d-flex align-items-center gap-3">
                                        ...
                                        <p className="mb-0">+91 8617064590</p>
                                    </ListGroupItem>
                        </ListGroup>
                    </Col>

                    <Col lg='12' className="text-center pt-5">
                        <p className="copyright">Copyright {year}, designed & developed by Avishek Singh. All rights reserved.</p>
                    </Col>
                </Row>
            </Container>
        </footer>
